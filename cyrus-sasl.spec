...
Patch36: cyrus-sasl-2.1.23-race.patch
...
%changelog
* Mon Apr 12 2010 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-8
- Update init script to impeach pid file (#576209)

* Mon Mar 29 2010 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-7
- solve race condition (#577770)

* Tue Mar 16 2010 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-6
-  update pre, post, preun, postun (#572255)

* Wed Mar 10 2010 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-5
- Rewrite spec file, make corect CFLAGS, CPPFLAGS and LDFLAGS,
  update postun (#572255)

* Fri Feb  5 2010 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-4.3
- Add man page to testtcpauthd (#562126)

* Wed Jan 27 2010 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-4.2
- Repair the provide field in spec (#558900)

* Fri Dec 11 2009 Dennis Gregorovic <dgregor@redhat.com> - 2.1.23-4.1
- Rebuilt for RHEL 6
